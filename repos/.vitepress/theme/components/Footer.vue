  ...
  <footer class="VPFooter">
    <div class="container">
      <p class="recordNo">
        ...
        <span class="content">
          <a href="https://beian.miit.gov.cn" target="_blank">{{ theme.footerConfig.icpRecordNo }}</a>
        </span>
      </p>
      <p v-if="theme.footerConfig?.publicSecurityRecordNo ?? false" class="recordNo">
        <span class="icon">
          <img src="/img/badge/gongan.png" title="公安备案号">
        </span>
        <span class="content">
          <a href="http://www.beian.gov.cn/portal/registerSystemInfo" target="_blank">{{ theme.footerConfig.publicSecurityRecordNo }}</a>
        </span>
      </p>
